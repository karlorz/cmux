...
|----------|-------------|
| `DEVSH_ORCHESTRATION_MODE` | Set to `1` when running as orchestrator |
| `DEVSH_HEAD_AGENT` | Name of the head agent coordinating |
| `DEVSH_ORCHESTRATION_ID` | Unique ID for this orchestration session |
| `DEVSH_PARENT_TASK_RUN_ID` | Parent task run ID (for nested orchestration) |
