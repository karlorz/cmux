...
const WORKER_PROCESS_TITLE = "cmux-worker";

// Harden the worker so an accidental `pkill node` doesn't kill it.
if (typeof process !== "undefined" && process.title !== WORKER_PROCESS_TITLE) {
  process.title = WORKER_PROCESS_TITLE;
}
