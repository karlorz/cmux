    ...
    <div className="relative flex min-h-dvh flex-col bg-[#030712] text-foreground">
      ...
      >
        ...
        <span className="text-sky-100/90">
          ...
          <span className="hidden sm:inline"> — The open source terminal and control plane for coding agents</span>
        </span>
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6">
                <h1 className="text-4xl font-semibold tracking-tight text-white sm:text-5xl">
                  Universal AI coding agent terminal and control plane
                </h1>
                <div className="space-y-4 text-base text-neutral-300 sm:text-lg">
                  <p>
                    cmux is the open source terminal and control plane for Claude Code, Codex, Gemini CLI, Amp, Opencode, and other coding agent CLIs.
                  </p>
                  <p>
      ...
      <footer className="border-t border-white/10 bg-black/50">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-6 px-4 py-8 text-sm text-neutral-500 sm:flex-row sm:px-6">
          <div className="flex items-center gap-2">
            ...
            <span className="font-mono">cmux</span>
          </div>
          <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-2">
            <a
              className="transition hover:text-white"
              href="https://github.com/karlorz/cmux"
              rel="noopener noreferrer"
              target="_blank"
            >
              GitHub
