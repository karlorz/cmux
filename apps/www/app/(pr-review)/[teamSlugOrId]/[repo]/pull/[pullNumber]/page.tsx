...
export default async function PullRequestPage({ params }: PageProps) {
  ...
  return (
    <div className="min-h-dvh bg-neutral-50 dark:bg-neutral-900 text-neutral-900 dark:text-neutral-50">
...
function PullRequestHeaderContent({
  ...
  return (
    <section className="rounded-xl border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-800 p-4 shadow-sm">
  ...
  return (
    <div className="flex-1 min-w-0">
      <div className="flex flex-wrap items-center gap-2 text-xs">
        ...
        />
        <span className="font-mono text-neutral-500 dark:text-neutral-400">#{pullNumber}</span>
...
function PullRequestHeaderMeta({
  ...
  return (
    <div className="mt-2 flex flex-wrap items-center gap-2 text-xs text-neutral-600 dark:text-neutral-400">
      {authorLogin ? (
        <>
          <span className="font-medium text-neutral-900 dark:text-neutral-200">@{authorLogin}</span>
