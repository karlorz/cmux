      ...
      <div className="flex h-full items-center justify-center p-4">
        {availablePanels.length > 0 ? (
          <div className="flex flex-col gap-2">
            <p className="text-xs text-center text-neutral-500 dark:text-neutral-400 mb-1">
              Add Panel
            </p>
            <div className="flex flex-wrap gap-2 justify-center">
              {availablePanels.map((panelType) => (
                <button
                  ...
                  className="flex flex-col items-center gap-2 rounded-lg border border-neutral-300 bg-white px-4 py-3 text-sm font-medium text-neutral-700 hover:bg-neutral-100 hover:border-neutral-400 dark:border-neutral-600 dark:bg-neutral-800 dark:text-neutral-200 dark:hover:bg-neutral-700 dark:hover:border-neutral-500 transition-colors min-w-[100px]"
                >
                  ...
                  <span className="text-xs">{PANEL_LABELS[panelType]}</span>
                </button>
              ))}
            </div>
          </div>
