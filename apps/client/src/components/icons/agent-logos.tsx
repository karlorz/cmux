...
function fallbackBadge(provider: string, className?: string) {
  const colors: Record<string, { bg: string; fg: string; label: string }> = {
    ...
    kimi: { bg: "#111827", fg: "#8b5cf6", label: "KI" },
    other: {
      bg: "#6B7280",
      fg: "#ffffff",
...
export const AgentLogo = memo(function AgentLogo({
  ...
  if (vendor === "kimi") {
    return (
      ...
      >
        <defs>
          <linearGradient id="kimiGradient" x1="0%" x2="100%" y1="0%" y2="100%">
        ...
        />
        <path
          d="M9 23V9h3.2l3.4 5.6L19.9 9H23v14h-3.1v-7.2l-3.3 5.3h-.2l-3.3-5.3V23H9z"
