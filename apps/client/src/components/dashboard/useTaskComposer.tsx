...
export type EnvironmentNewSearchParams = {
...
export type UseTaskComposerOptions = {
  enableGlobalKeyListener?: boolean;
};

export type UseTaskComposerResult = {
  ...
  onProjectSearchPaste: (value: string) => Promise<boolean>;
  branchOptions: string[];
  effectiveSelectedBranch: string[];
  ...
  shouldShowCloudRepoOnboarding: boolean;
  createEnvironmentSearch?: EnvironmentNewSearchParams;
  dismissCloudRepoOnboarding: () => void;
  selectedRepoFullName: string | null;
  onStartEnvironmentSetup: () => void;
};

export function useTaskComposer(
  teamSlugOrId: string,
  options?: UseTaskComposerOptions
): UseTaskComposerResult {
  ...
  const dismissCloudRepoOnboarding = useCallback(() => {
  ...
  const enableGlobalKeyListener = options?.enableGlobalKeyListener ?? true;

  useEffect(() => {
    if (!enableGlobalKeyListener) {
      return;
    }
  ...
  return {
    ...
    selectedRepoFullName,
    onStartEnvironmentSetup: handleStartEnvironmentSetup,
  };
}
