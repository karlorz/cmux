...
export interface DashboardTaskComposerResult {
...
interface DashboardTaskComposerOptions {
  teamSlugOrId: string;
  editorApiRef: RefObject<EditorApi | null>;
  preselectedEnvironmentId?: string;
}

export function useDashboardTaskComposer({
  teamSlugOrId,
  editorApiRef,
  preselectedEnvironmentId,
}: DashboardTaskComposerOptions): DashboardTaskComposerResult {
