...
import { MonitorUp, Plus, X } from "lucide-react";
...
export function TaskRunTerminalPane({ workspaceUrl }: TaskRunTerminalPaneProps) {
  ...
  useEffect(() => {
    if (hasTerminalBackend && !tabsQuery.isLoading && terminalIds.length === 0 && !hasAutoCreated.current) {
  ...
  }, [hasTerminalBackend, tabsQuery.isLoading, terminalIds.length, createTerminalMutation]);
  ...
  if (!xtermBaseUrl) {
    return (
      <div className="flex h-full flex-col items-center justify-center gap-2 text-sm text-neutral-500 dark:text-neutral-400">
        ...
        <span>Waiting for Cloud workspace to expose the terminal backend...</span>
      </div>
    );
  }

  return (
    <div className="flex flex-col grow bg-neutral-50 dark:bg-black h-full">
                    ...
                    <div key={id} className="relative pr-2">
                      <button
                        ...
                        className={clsx(
                          ...
                          isActive
                            ? "bg-neutral-700 text-neutral-50 dark:bg-neutral-700 dark:text-white"
                      ...
                      <button
                        ...
                        className={clsx(
                          ...
                          isActive
                            ? "text-neutral-100 hover:text-neutral-50 hover:bg-neutral-700/80 dark:text-white dark:hover:text-white dark:hover:bg-neutral-600"
