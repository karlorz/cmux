          ...
          >
            <Dialog.Portal>
              ...
              <Dialog.Content className="fixed inset-0 flex items-center justify-center p-6 focus:outline-none">
                <div className="relative flex w-full max-w-[95vw] h-[95vh] flex-col gap-3 rounded-2xl border border-neutral-200 bg-white/95 p-3 shadow-2xl focus:outline-none dark:border-neutral-800 dark:bg-neutral-950/90 sm:p-5">
