...
TEMP_DIR=$(mktemp -d)
APP_NAME="cmux-staging"  # Changed from "cmux" to "cmux-staging"
...
# Update Info.plist with staging-specific values
...
/usr/libexec/PlistBuddy -c "Set :CFBundleIdentifier com.cmux.staging" "$APP_DIR/Contents/Info.plist"  # Changed to staging bundle ID
