...
Examples:
  cmux orchestrate migrate --plan-file ./PLAN.json
  cmux orchestrate migrate --plan-file ./PLAN.json --agents-file ./AGENTS.json
  cmux orchestrate migrate --plan-file ./PLAN.json --agent claude/opus-4.5`,
