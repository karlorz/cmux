...
Examples:
  ...
  devsh orchestrate spawn --cloud-workspace --agent claude/opus-4.7 --effort max "Coordinate feature implementation"
  devsh orchestrate spawn --supervisor-profile <profile-id> --agent claude/opus-4.7 "Supervised task"
