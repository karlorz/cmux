...
echo "[cmux-devbox-lite] Starting services..."
...
echo "[cmux-devbox-lite] Auth token generated: ${AUTH_TOKEN:0:8}..."
...
echo "[cmux-devbox-lite] Boot ID saved: ${BOOT_ID:0:8}..."

# Start D-Bus for desktop environment
echo "[cmux-devbox-lite] Starting D-Bus..."
...
echo "[cmux-devbox-lite] Starting VNC server on display :1..."
...
echo "[cmux-devbox-lite] Starting cmux-code on port 39378..."
...
echo "[cmux-devbox-lite] Chrome CDP will be available on port 9222 (started via VNC)"
...
echo "[cmux-devbox-lite] Starting worker daemon on port 39377..."
/usr/local/bin/worker-daemon &

echo "[cmux-devbox-lite] All services started!"
echo "[cmux-devbox-lite] Services:"
...
echo ""
echo "[cmux-devbox-lite] Auth token stored at: $AUTH_TOKEN_FILE"
