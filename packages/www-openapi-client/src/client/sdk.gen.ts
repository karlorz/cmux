 ...
 */
export const postApiTaskRunsByIdForceWake = <ThrowOnError extends boolean = false>(options: Options<PostApiTaskRunsByIdForceWakeData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiTaskRunsByIdForceWakeResponses, PostApiTaskRunsByIdForceWakeErrors, ThrowOnError>({
