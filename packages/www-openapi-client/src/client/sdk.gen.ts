 ...
 */
export const postApiIntegrationsGithubPrsUpdate = <ThrowOnError extends boolean = false>(options: Options<PostApiIntegrationsGithubPrsUpdateData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiIntegrationsGithubPrsUpdateResponses, PostApiIntegrationsGithubPrsUpdateErrors, ThrowOnError>({
