 ...
 */
export const getApiGithubStats = <ThrowOnError extends boolean = false>(options?: Options<GetApiGithubStatsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetApiGithubStatsResponses, unknown, ThrowOnError>({
