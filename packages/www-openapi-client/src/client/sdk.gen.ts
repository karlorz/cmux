...
/**
 * Resume a Morph VM that backs a specific task run
 */
export const postApiMorphTaskRunsByTaskRunIdWake = <ThrowOnError extends boolean = false>(options: Options<PostApiMorphTaskRunsByTaskRunIdWakeData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiMorphTaskRunsByTaskRunIdWakeResponses, PostApiMorphTaskRunsByTaskRunIdWakeErrors, ThrowOnError>({
