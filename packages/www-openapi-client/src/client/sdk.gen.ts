 ...
 */
export const getApiIntegrationsGithubPrsMergeStatus = <ThrowOnError extends boolean = false>(options: Options<GetApiIntegrationsGithubPrsMergeStatusData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetApiIntegrationsGithubPrsMergeStatusResponses, GetApiIntegrationsGithubPrsMergeStatusErrors, ThrowOnError>({
