 ...
 */
export const postApiMorphForceWakeVm = <ThrowOnError extends boolean = false>(options: Options<PostApiMorphForceWakeVmData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiMorphForceWakeVmResponses, PostApiMorphForceWakeVmErrors, ThrowOnError>({
