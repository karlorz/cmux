...
export const getApiApiTeamsByTeamSlugOrIdCloudRepositories = <ThrowOnError extends boolean = false>(options: Options<GetApiApiTeamsByTeamSlugOrIdCloudRepositoriesData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetApiApiTeamsByTeamSlugOrIdCloudRepositoriesResponses, GetApiApiTeamsByTeamSlugOrIdCloudRepositoriesErrors, ThrowOnError>({
        url: '/api/api/teams/{teamSlugOrId}/cloud-repositories',
        ...options
    });
};

export const postApiApiTeamsByTeamSlugOrIdCloudRepositories = <ThrowOnError extends boolean = false>(options: Options<PostApiApiTeamsByTeamSlugOrIdCloudRepositoriesData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiApiTeamsByTeamSlugOrIdCloudRepositoriesResponses, PostApiApiTeamsByTeamSlugOrIdCloudRepositoriesErrors, ThrowOnError>({
        url: '/api/api/teams/{teamSlugOrId}/cloud-repositories',
        ...options,
        headers: {
            'Content-Type': 'application/json',
...
export const deleteApiApiTeamsByTeamSlugOrIdCloudRepositoriesById = <ThrowOnError extends boolean = false>(options: Options<DeleteApiApiTeamsByTeamSlugOrIdCloudRepositoriesByIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeleteApiApiTeamsByTeamSlugOrIdCloudRepositoriesByIdResponses, DeleteApiApiTeamsByTeamSlugOrIdCloudRepositoriesByIdErrors, ThrowOnError>({
        url: '/api/api/teams/{teamSlugOrId}/cloud-repositories/{id}',
        ...options
    });
};

export const getApiApiTeamsByTeamSlugOrIdCloudRepositoriesById = <ThrowOnError extends boolean = false>(options: Options<GetApiApiTeamsByTeamSlugOrIdCloudRepositoriesByIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetApiApiTeamsByTeamSlugOrIdCloudRepositoriesByIdResponses, GetApiApiTeamsByTeamSlugOrIdCloudRepositoriesByIdErrors, ThrowOnError>({
        url: '/api/api/teams/{teamSlugOrId}/cloud-repositories/{id}',
        ...options
    });
};

export const patchApiApiTeamsByTeamSlugOrIdCloudRepositoriesById = <ThrowOnError extends boolean = false>(options: Options<PatchApiApiTeamsByTeamSlugOrIdCloudRepositoriesByIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).patch<PatchApiApiTeamsByTeamSlugOrIdCloudRepositoriesByIdResponses, PatchApiApiTeamsByTeamSlugOrIdCloudRepositoriesByIdErrors, ThrowOnError>({
        url: '/api/api/teams/{teamSlugOrId}/cloud-repositories/{id}',
        ...options,
        headers: {
            'Content-Type': 'application/json',
...
export const postApiApiTeamsByTeamSlugOrIdCloudRepositoriesByIdSync = <ThrowOnError extends boolean = false>(options: Options<PostApiApiTeamsByTeamSlugOrIdCloudRepositoriesByIdSyncData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiApiTeamsByTeamSlugOrIdCloudRepositoriesByIdSyncResponses, PostApiApiTeamsByTeamSlugOrIdCloudRepositoriesByIdSyncErrors, ThrowOnError>({
        url: '/api/api/teams/{teamSlugOrId}/cloud-repositories/{id}/sync',
        ...options
    });
};

export const postApiSandboxesStartRepository = <ThrowOnError extends boolean = false>(options: Options<PostApiSandboxesStartRepositoryData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiSandboxesStartRepositoryResponses, PostApiSandboxesStartRepositoryErrors, ThrowOnError>({
