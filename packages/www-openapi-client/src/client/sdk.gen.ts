 ...
 */
export const postApiCloudSpawnAgents = <ThrowOnError extends boolean = false>(options: Options<PostApiCloudSpawnAgentsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiCloudSpawnAgentsResponses, PostApiCloudSpawnAgentsErrors, ThrowOnError>({
