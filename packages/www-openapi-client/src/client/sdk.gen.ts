...
/**
 * Run the maintenance script inside a sandbox to validate it
 */
export const postApiSandboxesByIdMaintenanceValidate = <ThrowOnError extends boolean = false>(options: Options<PostApiSandboxesByIdMaintenanceValidateData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiSandboxesByIdMaintenanceValidateResponses, PostApiSandboxesByIdMaintenanceValidateErrors, ThrowOnError>({
