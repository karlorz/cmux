...
/**
 * Force resume a Morph VM that backs a task run
 */
export const postApiMorphForceWake = <ThrowOnError extends boolean = false>(options: Options<PostApiMorphForceWakeData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiMorphForceWakeResponses, PostApiMorphForceWakeErrors, ThrowOnError>({
