...
/**
 * Force resume the Morph VM for a task run and wait until ready.
 */
export const postApiMorphTaskRunsWake = <ThrowOnError extends boolean = false>(options: Options<PostApiMorphTaskRunsWakeData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiMorphTaskRunsWakeResponses, PostApiMorphTaskRunsWakeErrors, ThrowOnError>({
