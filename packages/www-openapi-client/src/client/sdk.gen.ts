 ...
 */
export const postApiPveLxcTaskRunsByTaskRunIdRefreshGithubAuth = <ThrowOnError extends boolean = false>(options: Options<PostApiPveLxcTaskRunsByTaskRunIdRefreshGithubAuthData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiPveLxcTaskRunsByTaskRunIdRefreshGithubAuthResponses, PostApiPveLxcTaskRunsByTaskRunIdRefreshGithubAuthErrors, ThrowOnError>({
