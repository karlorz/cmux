 ...
 */
export const postApiMorphResumeInstance = <ThrowOnError extends boolean = false>(options: Options<PostApiMorphResumeInstanceData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiMorphResumeInstanceResponses, PostApiMorphResumeInstanceErrors, ThrowOnError>({
