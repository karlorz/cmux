 ...
 */
export const postApiMorphTaskRunsByTaskRunIdWakeMutation = (options?: Partial<Options<PostApiMorphTaskRunsByTaskRunIdWakeData>>): UseMutationOptions<PostApiMorphTaskRunsByTaskRunIdWakeResponse, DefaultError, Options<PostApiMorphTaskRunsByTaskRunIdWakeData>> => {
    const mutationOptions: UseMutationOptions<PostApiMorphTaskRunsByTaskRunIdWakeResponse, DefaultError, Options<PostApiMorphTaskRunsByTaskRunIdWakeData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiMorphTaskRunsByTaskRunIdWake({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
