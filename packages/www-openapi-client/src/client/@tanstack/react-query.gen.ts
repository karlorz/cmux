 ...
 */
export const postApiMorphTaskRunsWakeMutation = (options?: Partial<Options<PostApiMorphTaskRunsWakeData>>): UseMutationOptions<PostApiMorphTaskRunsWakeResponse, PostApiMorphTaskRunsWakeError, Options<PostApiMorphTaskRunsWakeData>> => {
    const mutationOptions: UseMutationOptions<PostApiMorphTaskRunsWakeResponse, PostApiMorphTaskRunsWakeError, Options<PostApiMorphTaskRunsWakeData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiMorphTaskRunsWake({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
