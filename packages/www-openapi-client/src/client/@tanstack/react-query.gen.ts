...
/**
 * Refresh GitHub authentication on a PVE LXC container
 * Re-authenticates the GitHub CLI inside a running PVE LXC container with a fresh token.
 */
export const postApiPveLxcTaskRunsByTaskRunIdRefreshGithubAuthMutation = (options?: Partial<Options<PostApiPveLxcTaskRunsByTaskRunIdRefreshGithubAuthData>>): UseMutationOptions<PostApiPveLxcTaskRunsByTaskRunIdRefreshGithubAuthResponse, DefaultError, Options<PostApiPveLxcTaskRunsByTaskRunIdRefreshGithubAuthData>> => {
    const mutationOptions: UseMutationOptions<PostApiPveLxcTaskRunsByTaskRunIdRefreshGithubAuthResponse, DefaultError, Options<PostApiPveLxcTaskRunsByTaskRunIdRefreshGithubAuthData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiPveLxcTaskRunsByTaskRunIdRefreshGithubAuth({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
