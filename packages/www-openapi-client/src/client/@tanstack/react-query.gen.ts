 ...
 */
export const postApiMorphForceWakeMutation = (options?: Partial<Options<PostApiMorphForceWakeData>>): UseMutationOptions<PostApiMorphForceWakeResponse, DefaultError, Options<PostApiMorphForceWakeData>> => {
    const mutationOptions: UseMutationOptions<PostApiMorphForceWakeResponse, DefaultError, Options<PostApiMorphForceWakeData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiMorphForceWake({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
