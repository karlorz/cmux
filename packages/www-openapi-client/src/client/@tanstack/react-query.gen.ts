...
/**
 * Spawn one or more agents in Morph-backed cloud sandboxes
 */
export const postApiCloudSpawnAgentsMutation = (options?: Partial<Options<PostApiCloudSpawnAgentsData>>): UseMutationOptions<PostApiCloudSpawnAgentsResponse, DefaultError, Options<PostApiCloudSpawnAgentsData>> => {
    const mutationOptions: UseMutationOptions<PostApiCloudSpawnAgentsResponse, DefaultError, Options<PostApiCloudSpawnAgentsData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiCloudSpawnAgents({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
