...
/**
 * Update GitHub pull request title or body using the user's GitHub OAuth token
 */
export const postApiIntegrationsGithubPrsUpdateMutation = (options?: Partial<Options<PostApiIntegrationsGithubPrsUpdateData>>): UseMutationOptions<PostApiIntegrationsGithubPrsUpdateResponse, DefaultError, Options<PostApiIntegrationsGithubPrsUpdateData>> => {
    const mutationOptions: UseMutationOptions<PostApiIntegrationsGithubPrsUpdateResponse, DefaultError, Options<PostApiIntegrationsGithubPrsUpdateData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiIntegrationsGithubPrsUpdate({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
