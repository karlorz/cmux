...
/**
 * Resume a paused Morph VM instance for a task run
 */
export const postApiMorphResumeInstanceMutation = (options?: Partial<Options<PostApiMorphResumeInstanceData>>): UseMutationOptions<PostApiMorphResumeInstanceResponse, DefaultError, Options<PostApiMorphResumeInstanceData>> => {
    const mutationOptions: UseMutationOptions<PostApiMorphResumeInstanceResponse, DefaultError, Options<PostApiMorphResumeInstanceData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiMorphResumeInstance({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
