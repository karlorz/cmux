 ...
 */
export const postApiMorphTaskRunsByTaskRunIdForceWakeMutation = (options?: Partial<Options<PostApiMorphTaskRunsByTaskRunIdForceWakeData>>): UseMutationOptions<PostApiMorphTaskRunsByTaskRunIdForceWakeResponse, DefaultError, Options<PostApiMorphTaskRunsByTaskRunIdForceWakeData>> => {
    const mutationOptions: UseMutationOptions<PostApiMorphTaskRunsByTaskRunIdForceWakeResponse, DefaultError, Options<PostApiMorphTaskRunsByTaskRunIdForceWakeData>> = {
        mutationFn: async (fnOptions) => {
