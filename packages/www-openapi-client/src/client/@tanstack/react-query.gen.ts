 ...
 */
export const postApiLearningLogMutation = (options?: Partial<Options<PostApiLearningLogData>>): UseMutationOptions<PostApiLearningLogResponse, DefaultError, Options<PostApiLearningLogData>> => {
    const mutationOptions: UseMutationOptions<PostApiLearningLogResponse, DefaultError, Options<PostApiLearningLogData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiLearningLog({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const getApiRulesQueryKey = (options?: Options<GetApiRulesData>) => createQueryKey('getApiRules', options);

/**
 * Get active orchestration rules
 * Fetch active orchestration rules for the team that are injected into agent prompts
 */
export const getApiRulesOptions = (options?: Options<GetApiRulesData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getApiRules({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getApiRulesQueryKey(options)
    });
};
