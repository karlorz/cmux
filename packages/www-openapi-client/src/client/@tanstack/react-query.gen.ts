 ...
 */
export const postApiSandboxesByIdMaintenanceValidateMutation = (options?: Partial<Options<PostApiSandboxesByIdMaintenanceValidateData>>): UseMutationOptions<PostApiSandboxesByIdMaintenanceValidateResponse, DefaultError, Options<PostApiSandboxesByIdMaintenanceValidateData>> => {
    const mutationOptions: UseMutationOptions<PostApiSandboxesByIdMaintenanceValidateResponse, DefaultError, Options<PostApiSandboxesByIdMaintenanceValidateData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiSandboxesByIdMaintenanceValidate({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
