 ...
 */
export const postApiMorphForceWakeVmMutation = (options?: Partial<Options<PostApiMorphForceWakeVmData>>): UseMutationOptions<PostApiMorphForceWakeVmResponse, DefaultError, Options<PostApiMorphForceWakeVmData>> => {
    const mutationOptions: UseMutationOptions<PostApiMorphForceWakeVmResponse, DefaultError, Options<PostApiMorphForceWakeVmData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiMorphForceWakeVm({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
