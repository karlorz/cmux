...
export const getApiGithubStatsQueryKey = (options?: Options<GetApiGithubStatsData>) => createQueryKey('getApiGithubStats', options);

/**
 * Get GitHub repository statistics
 */
export const getApiGithubStatsOptions = (options?: Options<GetApiGithubStatsData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getApiGithubStats({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getApiGithubStatsQueryKey(options)
    });
};
