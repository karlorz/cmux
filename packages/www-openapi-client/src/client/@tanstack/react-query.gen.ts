...
export const getApiApiTeamsByTeamSlugOrIdCloudRepositoriesQueryKey = (options: Options<GetApiApiTeamsByTeamSlugOrIdCloudRepositoriesData>) => createQueryKey('getApiApiTeamsByTeamSlugOrIdCloudRepositories', options);

export const getApiApiTeamsByTeamSlugOrIdCloudRepositoriesOptions = (options: Options<GetApiApiTeamsByTeamSlugOrIdCloudRepositoriesData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getApiApiTeamsByTeamSlugOrIdCloudRepositories({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getApiApiTeamsByTeamSlugOrIdCloudRepositoriesQueryKey(options)
    });
};

export const postApiApiTeamsByTeamSlugOrIdCloudRepositoriesMutation = (options?: Partial<Options<PostApiApiTeamsByTeamSlugOrIdCloudRepositoriesData>>): UseMutationOptions<PostApiApiTeamsByTeamSlugOrIdCloudRepositoriesResponse, DefaultError, Options<PostApiApiTeamsByTeamSlugOrIdCloudRepositoriesData>> => {
    const mutationOptions: UseMutationOptions<PostApiApiTeamsByTeamSlugOrIdCloudRepositoriesResponse, DefaultError, Options<PostApiApiTeamsByTeamSlugOrIdCloudRepositoriesData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiApiTeamsByTeamSlugOrIdCloudRepositories({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const deleteApiApiTeamsByTeamSlugOrIdCloudRepositoriesByIdMutation = (options?: Partial<Options<DeleteApiApiTeamsByTeamSlugOrIdCloudRepositoriesByIdData>>): UseMutationOptions<DeleteApiApiTeamsByTeamSlugOrIdCloudRepositoriesByIdResponse, DefaultError, Options<DeleteApiApiTeamsByTeamSlugOrIdCloudRepositoriesByIdData>> => {
    const mutationOptions: UseMutationOptions<DeleteApiApiTeamsByTeamSlugOrIdCloudRepositoriesByIdResponse, DefaultError, Options<DeleteApiApiTeamsByTeamSlugOrIdCloudRepositoriesByIdData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await deleteApiApiTeamsByTeamSlugOrIdCloudRepositoriesById({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const getApiApiTeamsByTeamSlugOrIdCloudRepositoriesByIdQueryKey = (options: Options<GetApiApiTeamsByTeamSlugOrIdCloudRepositoriesByIdData>) => createQueryKey('getApiApiTeamsByTeamSlugOrIdCloudRepositoriesById', options);

export const getApiApiTeamsByTeamSlugOrIdCloudRepositoriesByIdOptions = (options: Options<GetApiApiTeamsByTeamSlugOrIdCloudRepositoriesByIdData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getApiApiTeamsByTeamSlugOrIdCloudRepositoriesById({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getApiApiTeamsByTeamSlugOrIdCloudRepositoriesByIdQueryKey(options)
    });
};

export const patchApiApiTeamsByTeamSlugOrIdCloudRepositoriesByIdMutation = (options?: Partial<Options<PatchApiApiTeamsByTeamSlugOrIdCloudRepositoriesByIdData>>): UseMutationOptions<PatchApiApiTeamsByTeamSlugOrIdCloudRepositoriesByIdResponse, DefaultError, Options<PatchApiApiTeamsByTeamSlugOrIdCloudRepositoriesByIdData>> => {
    const mutationOptions: UseMutationOptions<PatchApiApiTeamsByTeamSlugOrIdCloudRepositoriesByIdResponse, DefaultError, Options<PatchApiApiTeamsByTeamSlugOrIdCloudRepositoriesByIdData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await patchApiApiTeamsByTeamSlugOrIdCloudRepositoriesById({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const postApiApiTeamsByTeamSlugOrIdCloudRepositoriesByIdSyncMutation = (options?: Partial<Options<PostApiApiTeamsByTeamSlugOrIdCloudRepositoriesByIdSyncData>>): UseMutationOptions<PostApiApiTeamsByTeamSlugOrIdCloudRepositoriesByIdSyncResponse, DefaultError, Options<PostApiApiTeamsByTeamSlugOrIdCloudRepositoriesByIdSyncData>> => {
    const mutationOptions: UseMutationOptions<PostApiApiTeamsByTeamSlugOrIdCloudRepositoriesByIdSyncResponse, DefaultError, Options<PostApiApiTeamsByTeamSlugOrIdCloudRepositoriesByIdSyncData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiApiTeamsByTeamSlugOrIdCloudRepositoriesByIdSync({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const postApiSandboxesStartRepositoryMutation = (options?: Partial<Options<PostApiSandboxesStartRepositoryData>>): UseMutationOptions<PostApiSandboxesStartRepositoryResponse, DefaultError, Options<PostApiSandboxesStartRepositoryData>> => {
    const mutationOptions: UseMutationOptions<PostApiSandboxesStartRepositoryResponse, DefaultError, Options<PostApiSandboxesStartRepositoryData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiSandboxesStartRepository({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
