...
export const getApiIntegrationsGithubPrsMergeStatusQueryKey = (options: Options<GetApiIntegrationsGithubPrsMergeStatusData>) => createQueryKey('getApiIntegrationsGithubPrsMergeStatus', options);

/**
 * Fetch mergeability information for a GitHub pull request
 */
export const getApiIntegrationsGithubPrsMergeStatusOptions = (options: Options<GetApiIntegrationsGithubPrsMergeStatusData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getApiIntegrationsGithubPrsMergeStatus({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getApiIntegrationsGithubPrsMergeStatusQueryKey(options)
    });
};
