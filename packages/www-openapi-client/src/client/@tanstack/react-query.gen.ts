...
/**
 * Resume a Morph sandbox for the selected task run
 */
export const postApiSandboxesTaskRunResumeMutation = (options?: Partial<Options<PostApiSandboxesTaskRunResumeData>>): UseMutationOptions<PostApiSandboxesTaskRunResumeResponse, DefaultError, Options<PostApiSandboxesTaskRunResumeData>> => {
    const mutationOptions: UseMutationOptions<PostApiSandboxesTaskRunResumeResponse, DefaultError, Options<PostApiSandboxesTaskRunResumeData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiSandboxesTaskRunResume({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
