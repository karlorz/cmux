 ...
 */
export const postApiMorphSetupInstanceMutation = (options?: Partial<Options<PostApiMorphSetupInstanceData>>): UseMutationOptions<PostApiMorphSetupInstanceResponse, PostApiMorphSetupInstanceError, Options<PostApiMorphSetupInstanceData>> => {
    const mutationOptions: UseMutationOptions<PostApiMorphSetupInstanceResponse, PostApiMorphSetupInstanceError, Options<PostApiMorphSetupInstanceData>> = {
        mutationFn: async (fnOptions) => {
