...
export const CODEX_AGENT_CONFIGS: AgentConfig[] = [
  CODEX_GPT_5_3_CODEX_XHIGH_REASONING_CONFIG,
  CODEX_GPT_5_3_CODEX_HIGH_REASONING_CONFIG,
  CODEX_GPT_5_3_CODEX_MEDIUM_REASONING_CONFIG,
  CODEX_GPT_5_3_CODEX_LOW_REASONING_CONFIG,
  CODEX_GPT_5_3_CODEX_CONFIG,
  ...
  CODEX_GPT_5_2_CODEX_LOW_REASONING_CONFIG,
  CODEX_GPT_5_2_CODEX_CONFIG,
  ...
  CODEX_GPT_5_2_CONFIG,
  CODEX_GPT_5_2_XHIGH_REASONING_CONFIG,
  CODEX_GPT_5_2_HIGH_REASONING_CONFIG,
  CODEX_GPT_5_2_MEDIUM_REASONING_CONFIG,
  CODEX_GPT_5_2_LOW_REASONING_CONFIG,
];
