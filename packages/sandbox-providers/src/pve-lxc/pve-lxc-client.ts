...
import { PVE_LXC_SNAPSHOT_PRESETS } from "@cmux/shared";
...
export class PveLxcClient {
  ...
  constructor(options: PveLxcClientOptions) {
    ...
    // PVE often uses self-signed certificates, so TLS verification is configurable.
    // We use undici fetch directly because some runtimes patch global fetch and ignore dispatcher.
