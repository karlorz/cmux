...
// Configurable via CMUX_BASE_URL env var - defaults to manaflow.com for upstream compatibility
const CMUX_BASE_URL = process.env.CMUX_BASE_URL || "https://manaflow.com";
const CMUX_BOT_NAME = process.env.CMUX_BOT_NAME || "manaflow";
const UTM_PARAMS = `utm_source=github&utm_medium=pr_comment&utm_campaign=${CMUX_BOT_NAME}_bot`;
const COMMENT_SIGNATURE = `_Generated by [${CMUX_BOT_NAME}](${CMUX_BASE_URL}?${UTM_PARAMS}&utm_content=signature)`;
...
const PREVIEW_SIGNATURE = `_Generated by [${CMUX_BOT_NAME}](${CMUX_BASE_URL}?${UTM_PARAMS}&utm_content=preview_signature) preview system_`;
const COMMENT_SIGNATURE_MATCHERS = [
  COMMENT_SIGNATURE,
  PREVIEW_SIGNATURE,
  // Dynamic signatures without UTM (for current CMUX_BASE_URL)
  `_Generated by [${CMUX_BOT_NAME}](${CMUX_BASE_URL})`,
  `_Generated by [${CMUX_BOT_NAME}](${CMUX_BASE_URL}) preview system_`,
  // Legacy upstream signatures for backwards compatibility (with and without UTM params)
  "_Generated by [cmux](https://cmux.dev)",
  "_Generated by [cmux](https://cmux.dev) preview system_",
  "_Generated by [cmux](https://cmux.dev?utm_source=github",
  "_Generated by [cmux](https://cmux.com)",
  "_Generated by [cmux](https://cmux.com) preview system_",
  "_Generated by [cmux](https://cmux.com?utm_source=github",
  "_Generated by [manaflow](https://manaflow.com)",
  "_Generated by [manaflow](https://manaflow.com) preview system_",
  "_Generated by [manaflow](https://manaflow.com?utm_source=github",
];
